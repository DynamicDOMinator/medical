...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
      <div className="max-w-5xl mt-3 sm:mt-4 rounded-full bg-white/95 backdrop-blur-md border border-slate-200/80 shadow-lg shadow-blue-950/10 mx-auto px-4 sm:px-6 lg:px-8 pointer-events-auto">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-1.5">
            ...
            <a
              ...
              className="ml-3 inline-flex items-center space-x-1.5 px-4.5 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-full transition-all shadow-md shadow-blue-600/20"
            >
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="md:hidden border-t border-blue-100 bg-white max-h-[80vh] overflow-y-auto">
