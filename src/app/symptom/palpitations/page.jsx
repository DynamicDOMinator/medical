...
export default function PalpitationsPage() {
  const faqs = [
    ...
    {
      question:
        "Are palpitations always a sign of a dangerous heart condition?",
      answer:
  ...
  const symptoms = [
    {
      title: "Skipped Beats & Pauses",
      desc: "Sensation that your heart hesitated or skipped a beat, followed by a heavy thump.",
      icon: HeartPulse,
    },
    {
      title: "Fluttering in Chest",
      desc: "Feeling like a butterfly or flip-flopping motion inside the central chest wall.",
      icon: Activity,
    },
    {
      title: "Rapid Pounding Pulse",
      desc: "Forceful thumping felt in the chest, neck, or throat even while resting.",
      icon: Zap,
    },
    {
      title: "Lightheadedness & Dizziness",
      desc: "Transient cerebral hypoperfusion during rapid paroxysmal arrhythmia spikes.",
      icon: AlertTriangle,
    },
    {
      title: "Shortness of Breath",
      desc: "Breathlessness accompanying sudden palpitations as cardiac filling efficiency drops.",
      icon: Clock,
    },
    {
      title: "Chest Tightness",
      desc: "Discomfort during prolonged tachycardia or when associated with underlying CAD.",
      icon: Heart,
    },
  ];
  ...
  const treatments = [
    {
      name: "Ambulatory Holter & Patch Monitoring",
      desc: "Continuous 24-hr to 14-day wearable ECG recording to capture irregular rhythm episodes.",
      duration: "24 hr – 14 Days",
    ...
    },
    {
      ...
      desc: "Minimally invasive radiofrequency or cryo energy ablation of abnormal electrical pathways causing SVT or AFib.",
      duration: "1–3 Hours",
      recovery: "1–2 Days",
      image:
    ...
    {
      name: "Anti-Arrhythmic & Beta-Blocker Drugs",
      desc: "Metoprolol, Bisoprolol, or Flecainide to stabilize sinus rhythm and control heart rate spikes.",
      duration: "Daily Protocol",
      recovery: "Long-term Control",
      image:
        "https://images.unsplash.com/photo-1471864190281-a93a3070b6de?auto=format&fit=crop&w=800&q=80",
    },
    {
      name: "Lifestyle & Stimulant Removal",
      desc: "Caffeine reduction, stress management, hydration, and electrolyte optimization.",
      duration: "Ongoing",
      ...
      <div className="bg-gradient-to-br from-slate-900 via-blue-950 to-sky-950 text-white pt-36 sm:pt-44 lg:pt-48 pb-16 sm:pb-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex items-center text-xs text-sky-300 font-bold mb-4 space-x-1.5 bg-white/10 w-fit px-3 py-1.5 rounded-full border border-white/20 backdrop-blur-md">
            <Link href="/symptom" className="hover:underline">
              Symptoms
            </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-5">
              ...
              <p className="text-blue-100 text-base sm:text-lg leading-relaxed max-w-2xl font-normal">
                Comprehensive guide to skipped beats, chest fluttering, Holter
                monitor diagnostics, electrophysiology evaluation, and catheter
                ablation by Dr. Mohamed Faher Almahmoud.
              </p>
              ...
              <div className="pt-4 border-t border-slate-100">
                <div className="bg-blue-50/80 p-4 rounded-2xl border border-blue-100">
                  ...
                  <p className="text-[11px] text-slate-600 mt-1">
                    Book an ambulatory ECG Holter monitor test.
                  </p>
                  <Link
                    href="/contact"
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            >
              ...
              <div className="space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                <p>
                  Heart palpitations are conscious sensations of an abnormal
                  heartbeat — described as fluttering, pounding, racing, or
                  skipping beats.
                </p>
                <p>
                  While many palpitations stem from benign causes like caffeine,
                  anxiety, or fatigue, others are driven by underlying
                  electrical arrhythmias requiring electrophysiology diagnostic
                  workup.
                </p>
              </div>
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    Diagnosis & Rhythm Testing
                  </h2>
                </div>
              </div>

              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Capturing rhythm during symptomatic episodes is key to
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-blue-200 hover:shadow-md transition-all flex flex-col justify-between overflow-hidden">
                  <div>
                    ...
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                      Continuous ECG rhythm logging during daily activity.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-blue-200 hover:shadow-md transition-all flex flex-col justify-between overflow-hidden">
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mb-2">
                      <CheckCircle className="h-5 w-5 text-blue-600 shrink-0" />
                      <h3 className="font-extrabold text-slate-900 text-base">
                        14-Day Extended Patch Monitor
                      </h3>
                    </div>
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                      Captures paroxysmal infrequent arrhythmias.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-blue-200 hover:shadow-md transition-all flex flex-col justify-between overflow-hidden">
                  <div>
                    ...
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                      Evaluates structural valve and myocardial muscle
                      integrity.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-blue-200 hover:shadow-md transition-all flex flex-col justify-between overflow-hidden">
                  <div>
                    ...
                    <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                      Assesses catecholamine/exertion-triggered arrhythmia
                      spikes.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-center space-x-2">
                      ...
                      <span>
                        Eliminate energy drinks, high-caffeine sodas, and excess
                        coffee
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-emerald-500 shrink-0" />
                      <span>
                        Maintain optimal hydration with water and electrolyte
                        balance
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-emerald-500 shrink-0" />
                      <span>
                        Avoid OTC decongestants containing pseudoephedrine
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <h4 className="font-bold text-slate-900 text-base">
                      Vagal Maneuvers & Stress Control
                    </h4>
                  </div>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-emerald-500 shrink-0" />
                      <span>
                        Learn bearing-down vagal maneuvers for sudden fast
                        rhythm episodes
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-emerald-500 shrink-0" />
                      <span>
                        Practice diaphragmatic breathing and mindfulness
                        meditation
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-emerald-500 shrink-0" />
                      <span>
                        Seek emergency care if palpitations cause syncope or
                        chest pain
                      </span>
                    </li>
                  </ul>
