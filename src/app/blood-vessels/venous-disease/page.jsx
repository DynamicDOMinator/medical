...
export default function VenousDiseasePage() {
  ...
  const faqs = [
    ...
    {
      question: 'Are varicose veins just a cosmetic issue or a medical condition?',
      answer:
    ...
    {
      question: 'Are endovenous laser and radiofrequency ablation procedures painful?',
      answer:
    ...
    {
      question: 'Will insurance cover treatment for varicose veins and venous disease?',
      answer:
  ...
  const riskFactors = [
    { name: 'Genetics & Family History', detail: 'Over 70% of patients with venous reflux have a first-degree relative with vein disease.' },
    { name: 'Prolonged Standing or Sitting', detail: 'Occupations requiring hours of stillness prevent leg calf muscles from pumping blood.' },
    { name: 'Pregnancy & Hormonal Shifts', detail: 'Increased blood volume and pelvic pressure relax vein walls during pregnancy.' },
    { name: 'Age & Obesity', detail: 'Natural loss of vein wall elasticity combined with excess abdominal pressure on venous return.' },
    { name: 'Prior Deep Vein Thrombosis (DVT)', detail: 'Post-thrombotic syndrome damages vein valves following a major blood clot.' },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-5">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
                Venous Disease & <br />
                <span className="animated-gradient-text">Chronic Insufficiency</span>
              </h1>
              <p className="text-blue-100 text-base sm:text-lg leading-relaxed max-w-2xl font-normal">
                Comprehensive patient guide to lower limb venous reflux, varicose veins, chronic leg swelling, stasis ulcerations, and state-of-the-art endovascular therapies by Dr. Mohamed Faher Almahmoud.
              </p>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative h-64 sm:h-72 lg:h-80 rounded-3xl overflow-hidden border-2 border-white/20 shadow-2xl bg-slate-950 group">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-md p-3.5 rounded-2xl border border-blue-100 flex items-center justify-between">
                  <div>
                    <p className="text-xs font-extrabold text-slate-900">RPVI Certified Ultrasound</p>
                    <p className="text-[11px] text-blue-600 font-semibold">In-Clinic Duplex Mapping</p>
                  </div>
            ...
            <div className="sticky top-28 bg-white border border-blue-100 rounded-3xl p-6 space-y-4 shadow-sm">
              ...
              <div className="pt-4 border-t border-slate-100 space-y-3">
                <div className="bg-blue-50/80 p-4 rounded-2xl border border-blue-100">
                  <p className="text-xs font-bold text-blue-900">Need Immediate Evaluation?</p>
                  <p className="text-[11px] text-slate-600 mt-1">Book an appointment at PulseCare Cardiology Clinic.</p>
                  <Link
                    href="/contact"
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <section id="overview" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-blue-600">Pathophysiology</span>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">What is Venous Disease?</h2>
                </div>
              </div>

              <div className="space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                <p>
                  Venous disease encompasses a wide spectrum of vascular conditions where the veins in the lower extremities struggle to pump oxygen-depleted blood back to the heart against gravity. Under normal conditions, tiny, delicate one-way valves inside your leg veins close to prevent blood from flowing backward.
                </p>
                <p>
                  When these vein valves become damaged, stretched, or incompetent, blood begins to pool in the lower leg veins — a condition known as <strong>venous reflux</strong> or <strong>Chronic Venous Insufficiency (CVI)</strong>. Over time, high blood pressure inside the veins causes vessel walls to expand, leading to painful swelling, spider veins, bulging varicose veins, and skin ulcerations.
                </p>
              </div>
            ...
            <section id="symptoms" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div>
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Common Symptoms of Venous Insufficiency</h2>
                </div>
              </div>
            ...
            <section id="causes" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">What Triggers Vein Valve Damage?</h2>
                </div>
              </div>
            ...
            <section id="diagnosis" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-blue-600">RPVI Certified Diagnostics</span>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Vascular Duplex Ultrasound Scan</h2>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-7 space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                  ...
                  <div className="bg-blue-50/70 p-4 rounded-2xl border border-blue-100 space-y-2">
                    <h4 className="font-bold text-blue-950 text-sm">What Ultrasound Reveals:</h4>
            ...
            <section id="treatments" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-blue-600">Modern Clinical Therapies</span>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Minimally Invasive Endovenous Procedures</h2>
                </div>
              </div>
            ...
            <section id="prevention" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-emerald-600">Self-Care & Management</span>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Lifestyle & Compression Protocol</h2>
                </div>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-2xl bg-emerald-50/50 border border-emerald-100 space-y-2">
                  <h4 className="font-bold text-slate-900 text-sm">Graduated Compression</h4>
                  <p className="text-slate-600 text-xs leading-relaxed">
                    Wear 20-30 mmHg prescription compression stockings during prolonged standing or travel.
                  </p>
                </div>
                <div className="p-5 rounded-2xl bg-emerald-50/50 border border-emerald-100 space-y-2">
                  <h4 className="font-bold text-slate-900 text-sm">Leg Elevation Routine</h4>
                  <p className="text-slate-600 text-xs leading-relaxed">
                    Elevate legs above heart level for 15-20 minutes 3 times daily to assist gravity venous drain.
                  </p>
                </div>
                <div className="p-5 rounded-2xl bg-emerald-50/50 border border-emerald-100 space-y-2">
                  <h4 className="font-bold text-slate-900 text-sm">Calf Muscle Flexing</h4>
                  <p className="text-slate-600 text-xs leading-relaxed">
                    Engage in regular walking and ankle flex exercises to activate calf muscle venous pumps.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 rounded-3xl p-8 text-white shadow-2xl border border-blue-800/40 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="space-y-2 text-center sm:text-left">
                <h3 className="text-2xl font-extrabold">Ready for relief from leg swelling & vein pain?</h3>
                <p className="text-blue-100 text-sm">Schedule a comprehensive vascular duplex evaluation with Dr. Almahmoud.</p>
              </div>
              <Link
                href="/contact"
