            ...
            <div className="lg:col-span-5 relative">
              <div className="relative h-64 sm:h-72 lg:h-80 rounded-3xl overflow-hidden border-2 border-white/20 shadow-2xl bg-slate-950 group">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-md p-3.5 rounded-2xl border border-blue-100 flex items-center justify-between">
                  <div>
                    <p className="text-xs font-extrabold text-slate-900">Structural Heart Center</p>
                    <p className="text-[11px] text-blue-600 font-semibold">TAVR & MitraClip Procedures</p>
                  </div>
                  <span className="bg-blue-600 text-white text-[10px] font-bold px-2.5 py-1 rounded-lg">Advanced Care</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <section id="overview" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-center bg-slate-50 p-5 rounded-2xl border border-slate-200/80">
                ...
                <div className="space-y-2">
                  <h4 className="font-extrabold text-slate-900 text-base">Primary Valve Conditions:</h4>
                  <ul className="space-y-2 text-xs text-slate-600">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 shrink-0" />
                      <span><strong>Aortic Stenosis:</strong> Calcification narrowing the aortic outflow tract.</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 shrink-0" />
                      <span><strong>Mitral Regurgitation:</strong> Backflow of blood from ventricle to left atrium.</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-blue-600 shrink-0" />
                      <span><strong>Mitral Valve Prolapse:</strong> Floppy valve leaflets bowing into atrium.</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="lg:col-span-5 relative">
                  <div className="relative h-64 rounded-2xl overflow-hidden border border-blue-200 shadow-lg">
                    <Image
                      ...
                      alt="Echocardiogram Examination"
                      fill
                      className="object-cover"
                    />
                  </div>
