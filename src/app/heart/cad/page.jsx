...
export default function CADHeartPage() {
  const faqs = [
    {
    ...
    {
      question: 'Can coronary plaque build-up be prevented or stabilized?',
      answer:
        'Yes. High-intensity statin therapy, PCSK9 inhibitors, antiplatelet agents (aspirin), blood pressure control, and smoking cessation stabilize vulnerable soft plaques and dramatically reduce future heart attack risks.',
    },
  ];
  ...
  const riskFactors = [
    { name: 'High Blood Cholesterol (Elevated LDL-C)', detail: 'Circulating LDL particles penetrate the coronary intima, initiating plaque formation.' },
    { name: 'Hypertension (High Blood Pressure)', detail: 'Causes mechanical shear stress on coronary arterial walls, accelerating atherogenesis.' },
    { name: 'Cigarette Smoking', detail: 'Endothelial toxin that damages vessel walls and increases blood clot formation.' },
    { name: 'Diabetes & Insulin Resistance', detail: 'High blood sugar promotes diffuse coronary artery inflammation and microvascular damage.' },
    { name: 'Sedentary Lifestyle & Obesity', detail: 'Contributes to metabolic syndrome, systemic inflammation, and adverse lipid profiles.' },
  ];

  const treatments = [
    {
      name: 'Percutaneous Coronary Intervention (PCI / Stenting)',
      desc: 'Minimally invasive catheterization where a tiny balloon dilates blocked heart arteries and a Drug-Eluting Stent (DES) scaffolds it open.',
      duration: '45-60 Mins',
      recovery: '1-2 Days',
    },
    {
      name: 'Fractional Flow Reserve (FFR / iFR) Assessment',
      desc: 'Pressure wire measurement inside coronary arteries to determine if a narrowed artery truly starves heart muscle of blood flow.',
      duration: '30 Mins',
      recovery: 'Same Day',
    },
    {
      name: 'Intravascular Ultrasound (IVUS) & OCT Imaging',
      desc: 'High-definition sound and light wave cameras inserted inside coronary vessels to view plaque composition and stent expansion.',
      duration: 'Diagnostic',
      recovery: 'Immediate',
    },
    {
      name: 'Optimal Medical Therapy (OMT)',
      desc: 'Guideline-directed medical management using Dual Antiplatelet Therapy (DAPT), statins, beta-blockers, and ACE-inhibitors.',
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <section id="overview" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              ...
              <div className="space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                ...
                <p>
                  As atherosclerotic plaque grows, it restricts blood flow to the myocardium during physical exertion or stress (causing <strong>Angina Pectoris</strong>). If a plaque ruptures, a blood clot forms instantly, completely occluding coronary blood flow and triggering a acute <strong>Myocardial Infarction (Heart Attack)</strong>.
                </p>
              </div>

              {/* Explanatory Diagram Box */}
            ...
            <section id="diagnosis" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-7 space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                  <p>
                    Accurate diagnosis combines non-invasive risk stratification with advanced anatomical imaging. At PulseCare Cardiology Clinic, Dr. Almahmoud utilizes state-of-the-art diagnostic modalities:
                  </p>
