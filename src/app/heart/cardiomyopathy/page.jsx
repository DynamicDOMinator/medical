                  ...
                  <div className="bg-blue-50/70 p-4 rounded-2xl border border-blue-100 space-y-2">
                    ...
                    <ul className="space-y-1.5 text-xs text-slate-700">
                      <li className="flex items-center space-x-2">
                        ...
                        <span><strong>Echocardiography:</strong> Primary test for wall thickness and EF.</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="h-4 w-4 text-blue-600 shrink-0" />
                        <span><strong>Cardiac MRI (CMR):</strong> Gold standard for myocardial tissue fibrosis characterization.</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle className="h-4 w-4 text-blue-600 shrink-0" />
            ...
            <section id="treatment" className="bg-white border border-blue-100 rounded-3xl p-6 sm:p-10 shadow-xs scroll-mt-24">
              ...
              <div className="mt-8 relative h-64 rounded-2xl overflow-hidden border border-blue-100 shadow-md">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <p className="text-xs uppercase tracking-wider font-extrabold text-sky-300">Advanced Electrophysiology & Surgery</p>
                  <p className="text-sm font-bold">Implantable cardioverter defibrillator (ICD) placement for SCD prevention.</p>
                </div>
              </div>
            </section>
